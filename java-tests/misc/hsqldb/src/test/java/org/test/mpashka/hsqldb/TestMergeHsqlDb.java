...
@Slf4j
public class TestMergeHsqlDb {

    @Test
    public void testMerge() throws Exception {
//        Connection c = DriverManager.getConnection("jdbc:hsqldb:file:/opt/db/testdb", "SA", "");
        try (Connection con = DriverManager.getConnection("jdbc:hsqldb:mem:test;sql.syntax_ora=true;hsqldb.tx=mvcc;default_schema=test", "user1", "pass")) {
